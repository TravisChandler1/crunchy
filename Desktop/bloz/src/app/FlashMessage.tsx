...
export default function FlashMessage() {
  ...
  return (
    <div
      className={`fixed left-1/2 bottom-8 z-[1000] -translate-x-1/2 px-8 py-4 rounded-full bg-yellow-300 text-yellow-900 font-bold text-lg shadow-lg border border-yellow-200 pointer-events-none transition-transform duration-2000 ease-in-out animate-flash-move-fade ${show ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-32"}`}
      style={{
