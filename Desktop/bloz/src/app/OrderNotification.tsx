...
export default function OrderNotification() {
  ...
  return (
    <div className="fixed bottom-24 left-1/2 -translate-x-1/2 z-[2100] bg-yellow-300 text-yellow-900 font-bold px-8 py-4 rounded-full shadow-lg border border-yellow-200 animate-toast-zoom-fade text-lg text-center">
      {notification}
    </div>
  );
} 